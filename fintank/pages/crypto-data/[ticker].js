...
export async function getServerSideProps({query }) {
    ...
    console.log(ticker)
    const stockRequested = await axios.get(`${process.env.NEXT_PUBLIC_FINTANK_API_URL}/crypto-data/${ticker}`);
          ...
          <Row>
            <Col lg="8">
              ...
              {roomData.frequencies && (
                <React.Fragment>
                  <div className="text-block">
                    <h4 className="mb-4">Crypto Price Movements</h4>
                    <Row>
            ...
            <Col lg="4">
              ...
              >
                ...
                <hr className="my-1" />
                <h5 className="text-sm text-center">
                  Market Cap: {Intl.NumberFormat().format(dataForStock?.marketCap)}
                </h5>
                <hr className="my-1" />
                <h5 className="text-sm text-center">
                ...
                <hr className="my-1" />
                <h5 className="text-sm text-center">
                  Volume {Intl.NumberFormat().format(dataForStock?.volume)}
                </h5>
                <hr className="my-1" />
                <h5 className="text-sm text-center">
                ...
                <hr className="my-1" />
                <h5 className="text-sm text-center">
                  Shares Outstanding {Intl.NumberFormat().format(dataForStock?.sharesOutstanding)}
                </h5>
                <hr className="my-4" />
              </div>
            </Col>
